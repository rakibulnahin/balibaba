          ...
          >
            {
              banner.map((value, index) => (
                <div className='flexRowCenter w-full h-80 rounded-lg'>
      ...
      <div className=' z-10 px-10 gap-8 -mt-28 mb-28 lg:w-[1400px]  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>

        {
          tags.map((value, index) => (
            <span className='p-3 w-72 shadow-left shadow-third/40 rounded-md bg-white flexColCenter hover:text-second cursor-default'>
        ...
        <div className='gap-5 lg:w-[1400px] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6'>

          {
            data.map((value, index) => (
              <span className='relative group w-full shadow-left shadow-third/40 rounded-md bg-white flexColCenter cursor-default overflow-hidden'>
                <img className='w-full h-56 rounded-t-lg' src={value.image} />
                {
